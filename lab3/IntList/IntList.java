...
public class IntList {
     ...
     * as an input, returns null. iterative method.
     * @param A IntList
     */
     ...
     * Returns the reverse of the given IntList.
     * This method is destructive. If given null
     * as an input, returns null. recursive method.
     * Reverse from the end to the front, each time
     * set the end of reverse to null.
     * @param A IntList
     */
